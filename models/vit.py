...
def vit_t_16(*, image_size: int = 224, num_classes: int = 1000, **kwargs: Any) -> VisionTransformer:
    """
    ViT-Tiny/16: patch 16, embed_dim=192, depth=12, heads=3, mlp_dim=768.
    Structure aligns with Google / timm vit_tiny_patch16_224.
    """
...
def vit_s_16(*, image_size: int = 224, num_classes: int = 1000, **kwargs: Any) -> VisionTransformer:
    """
    ViT-Small/16: patch 16, embed_dim=384, depth=12, heads=6, mlp_dim=1536.
    Align with vit_small_patch16_224.
    """
    return VisionTransformer(
        image_size=image_size,
        patch_size=16,
